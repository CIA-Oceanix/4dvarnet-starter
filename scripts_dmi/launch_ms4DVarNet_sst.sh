...
python ${store_dir}/itrp_LR_to_HR.py ${store_dir}/training_dataset/DMI-L3S_GHRSST-SSTsubskin-night_SST_UHR_NRT-NSEABALTIC.nc ${store_dir}/training_dataset/DMI-L4_GHRSST-SSTfnd-4DVarNet_coarse-NSEABALTIC.nc ${store_dir}/training_dataset/DMI-L3S_GHRSST-SSTsubskin-night_SST_UHR_NRT-NSEABALTIC_w4DVarNet_coarse.nc
...
python ${store_dir}/itrp_LR_to_HR.py ${store_dir}/validation_dataset/DMI-L3S_GHRSST-SSTsubskin-night_SST_UHR_NRT-NSEABALTIC_validation_s0.nc ${store_dir}/validation_dataset/DMI-L4_GHRSST-SSTfnd-4DVarNet_coarse-NSEABALTIC_2021.nc ${store_dir}/validation_dataset/DMI-L4_GHRSST-SSTfnd-4DVarNet_coarse-NSEABALTIC_2021.nc
