...
def base_training(trainer, dm, lit_mod, test_dm=None, test_fn=None, ckpt=None):
    ...
    lit_mod.load_from_checkpoint('xxxxxx.ckpt')#'/homes/rfablet/Home2/Research/Python/Git_rfablet/4dvarnet-starter/outputs/2023-05-07/22-59-30/base_l63/checkpoints/val_mse=0.6534-epoch=379.ckpt')
