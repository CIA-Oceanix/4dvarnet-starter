...
def base_training(trainer, dm, lit_mod, test_dm=None, test_fn=None, ckpt=None):
    ...
    print(lit_mod.model.model_Grad.lstm.Gates.weight[0,0,:,:],flush=True)
    print('.... %f  -- %f -- %d'%(lit_mod.model.lr_grad,lit_mod.model.lr_rnd,lit_mod.model.model_Grad.sig_lstm_init),flush=True)
    print('.... %d  -- %d -- %d'%(lit_mod.model.n_grad,lit_mod.model.k_n_grad,lit_mod.model.n_step),flush=True)
    print()
