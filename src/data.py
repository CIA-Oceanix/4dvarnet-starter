...
'''
    SST
'''
class BaseDataModule_SST(pl.LightningDataModule):
    def __init__(self, input_da, domains, xrds_kw, dl_kw, aug_kw=None, norm_stats=None, **kwargs):
        super().__init__()
        self.input_da = input_da
        self.domains = domains
...
'''
    SST + SLA input
'''
class BaseDataModule_SST_SLA_INPUT(pl.LightningDataModule):
    def __init__(self, input_da, domains, xrds_kw, dl_kw, aug_kw=None, norm_stats=None, **kwargs):
        super().__init__()
        self.input_da = input_da
        self.domains = domains
    ...
    def post_fn(self):
        ...
        return ft.partial(ft.reduce, lambda i, f: f(i), [
            TrainingItem_SLA_INPUT._make, # TrainingItem_sst for L3
            lambda item: item._replace(tgt=normalize(item.tgt)),
            lambda item: item._replace(input=normalize(item.input)),
...
'''
    Salinity module
'''
class BaseDataModule_SSS(pl.LightningDataModule):
    def __init__(self, input_da, domains, xrds_kw, dl_kw, aug_kw=None, norm_stats=None, **kwargs):
        super().__init__()
        self.input_da = input_da
        self.domains = domains
    ...
    def post_fn(self):
        ...
        return ft.partial(ft.reduce, lambda i, f: f(i), [
            TrainingItem._make, # TrainingItem_sst for L3
            lambda item: item._replace(tgt=normalize(item.tgt)),
            lambda item: item._replace(input=normalize(item.input)),
            #lambda item: item._replace(sst_anomaly=normalize(item.sst_anomaly)),
        ])
...
class BaseDataModuleOSE(pl.LightningDataModule):
    def __init__(self, input_da, domains, xrds_kw, dl_kw, aug_kw=None, norm_stats=None, **kwargs):
        super().__init__()
        self.input_da = input_da
        self.domains = domains
    ...
    def post_fn(self):
        ...
        return ft.partial(ft.reduce, lambda i, f: f(i), [
            TrainingItemOSE._make,
            lambda item: item._replace(tgt=normalize(item.tgt)),
            lambda item: item._replace(input=normalize(item.input)),
            lambda item: item._replace(input_complete=normalize(item.input_complete)),
        ])
