...
'''
    SST 
'''
class MovingPatchDataModule_SST(BaseDataModule_SST):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
'''
    SST and SLA input
'''
class MovingPatchDataModule_SST_SLA_INPUT(BaseDataModule_SST_SLA_INPUT):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class XrDatasetMovingPatchFastRecGPU_NOISE(XrDatasetMovingPatch):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._rng = np.random.default_rng()
        self.noise = 0.02 * 1.5
...
class XrDatasetMovingPatchFastRecGPU_PREVIOUS_VERSION(XrDatasetMovingPatch):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._rng = np.random.default_rng()
        self.noise = 0.02 * 1.5
...
'''
    SST and SLA Input
'''
class MovingPatchDataModuleFastRecGPU_SST_SLA_INPUT(MovingPatchDataModule_SST_SLA_INPUT):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
'''
    SST
'''
class MovingPatchDataModuleFastRecGPU_SST(MovingPatchDataModule_SST):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class MovingPatchDataModuleFastRecGPU_NOISE(MovingPatchDataModule):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    def setup(self, stage='test'):
        ...
        # calling MovingPatch Datasets, rand=True for train only
        post_fn = self.post_fn()
        self.train_ds = XrDatasetMovingPatchFastRecGPU_NOISE(
            self.input_da.sel(self.domains['train']), **self.xrds_kw, postpro_fn=post_fn, rand=True
        )
        self.val_ds = XrDatasetMovingPatchFastRecGPU_NOISE(
            self.input_da.sel(self.domains['val']), **self.xrds_kw, postpro_fn=post_fn, rand=False
        )
        self.test_ds = XrDatasetMovingPatchFastRecGPU(
            self.input_da.sel(self.domains['test']), **self.xrds_kw, postpro_fn=post_fn, rand=False
